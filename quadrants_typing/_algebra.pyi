...
class Integer(Number):
    ...
    # A shift count is any integer, not a same-width operand (unlike `&`/`|`/`^`);
    # the result keeps the shifted value's type.
    def __lshift__(self, other: int | Integer, /) -> Self: ...
    def __rlshift__(self, other: int | Integer, /) -> Self: ...
    def __rshift__(self, other: int | Integer, /) -> Self: ...
    def __rrshift__(self, other: int | Integer, /) -> Self: ...
