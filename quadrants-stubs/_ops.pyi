...
def func(fn: _F, /) -> _F: ...
@overload
def func(*, is_real_function: bool = ..., requires_top_level: bool = ...) -> Callable[[_F], _F]: ...
@overload
def kernel(fn: _F, /) -> _F: ...
@overload
def kernel(
...
def bit_cast[T_: qdt.DType](obj: qdt.DType, dtype: type[T_]) -> T_: ...
...
def random[T: qdt.DType](dtype: type[T]) -> T: ...

# --- SIMT namespace ---
class _BlockSIMT:
    def reduce_add[T: qdt.DType](self, value: T, block_dim: int, dtype: type[T], /) -> T: ...
