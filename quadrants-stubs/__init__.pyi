...
# `length` at top level is the SNode axis length, distinct from `math.length`.
def length(node: Any, indices: Any) -> i32: ...
def template(element_type: type[Any] = ..., ndim: int | None = None) -> Any: ...
@overload
